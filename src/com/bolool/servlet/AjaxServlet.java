...
//		System.out.println(boloolJSON);
		...
		boloolCount += DBHelper.insertOrUpdatePre(Const.BOLOOL_SQL30,bolool.getId(),bolool.getHscore(),bolool.getAscore(),bolool.getHresult(),bolool.getAresult(),
				bolool.getHsection(),bolool.getAsection());
		bolool = boloolData.get("top33");
		boloolCount += DBHelper.insertOrUpdatePre(Const.BOLOOL_SQL33,bolool.getId(),bolool.getHscore(),bolool.getAscore(),bolool.getHresult(),bolool.getAresult(),
				bolool.getHsection(),bolool.getAsection());
...
//		String asection = request.getParameter("asection");
		...
		String sql = "select m."+column+" from t_match_odds o left join t_match m on o.matchId = m.id left join t_bolool"+topN+" b on m.id = b.id ";
